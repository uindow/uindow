...
This product uses third party software in accordance with their respective licenses:
  ...
  * **[builder-util-runtime](https://npmjs.com/package/builder-util-runtime)** `v.9.6.0` ⚖️ license: [MIT](./dist/lic/builder-util-runtime.license.md) • author: Vladimir Krivosheev
  * **[debug](https://npmjs.com/package/debug)** `v.4.4.3` ⚖️ license: [MIT](./dist/lic/debug.license.md) • author: Josh Junon (https://github.com/qix-)
  * **[electron-updater](https://npmjs.com/package/electron-updater)** `v.6.8.5` ⚖️ license: [MIT](./dist/lic/electron-updater.license.md) • author: Vladimir Krivosheev
  ...
  * **[semver](https://npmjs.com/package/semver)** `v.7.7.4` ⚖️ license: [ISC](./dist/lic/semver.license.md) • author: GitHub Inc.
